...
Defined in: [packages/db/src/strategies/throttleStrategy.ts:48](https://github.com/fezproof/tanstack-db/blob/main/packages/db/src/strategies/throttleStrategy.ts#L48)
