...
Defined in: [packages/db/src/query/expression-helpers.ts:127](https://github.com/fezproof/tanstack-db/blob/main/packages/db/src/query/expression-helpers.ts#L127)
