...
Defined in: [packages/query-db-collection/src/errors.ts:4](https://github.com/fezproof/tanstack-db/blob/main/packages/query-db-collection/src/errors.ts#L4)
...
Defined in: [packages/query-db-collection/src/errors.ts:5](https://github.com/fezproof/tanstack-db/blob/main/packages/query-db-collection/src/errors.ts#L5)
