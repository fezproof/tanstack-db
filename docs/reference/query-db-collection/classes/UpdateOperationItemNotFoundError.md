...
Defined in: [packages/query-db-collection/src/errors.ts:69](https://github.com/fezproof/tanstack-db/blob/main/packages/query-db-collection/src/errors.ts#L69)
...
Defined in: [packages/query-db-collection/src/errors.ts:70](https://github.com/fezproof/tanstack-db/blob/main/packages/query-db-collection/src/errors.ts#L70)
