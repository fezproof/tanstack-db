...
Defined in: [packages/query-db-collection/src/errors.ts:83](https://github.com/fezproof/tanstack-db/blob/main/packages/query-db-collection/src/errors.ts#L83)
...
Defined in: [packages/query-db-collection/src/errors.ts:84](https://github.com/fezproof/tanstack-db/blob/main/packages/query-db-collection/src/errors.ts#L84)
