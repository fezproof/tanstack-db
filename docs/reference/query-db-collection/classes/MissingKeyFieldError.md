...
Defined in: [packages/query-db-collection/src/errors.ts:97](https://github.com/fezproof/tanstack-db/blob/main/packages/query-db-collection/src/errors.ts#L97)
...
Defined in: [packages/query-db-collection/src/errors.ts:98](https://github.com/fezproof/tanstack-db/blob/main/packages/query-db-collection/src/errors.ts#L98)
