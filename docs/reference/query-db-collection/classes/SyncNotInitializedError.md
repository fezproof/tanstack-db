...
Defined in: [packages/query-db-collection/src/errors.ts:39](https://github.com/fezproof/tanstack-db/blob/main/packages/query-db-collection/src/errors.ts#L39)
...
Defined in: [packages/query-db-collection/src/errors.ts:40](https://github.com/fezproof/tanstack-db/blob/main/packages/query-db-collection/src/errors.ts#L40)
