...
Defined in: [packages/query-db-collection/src/errors.ts:18](https://github.com/fezproof/tanstack-db/blob/main/packages/query-db-collection/src/errors.ts#L18)
...
Defined in: [packages/query-db-collection/src/errors.ts:19](https://github.com/fezproof/tanstack-db/blob/main/packages/query-db-collection/src/errors.ts#L19)
