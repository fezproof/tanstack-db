...
Defined in: [packages/query-db-collection/src/errors.ts:32](https://github.com/fezproof/tanstack-db/blob/main/packages/query-db-collection/src/errors.ts#L32)
...
Defined in: [packages/query-db-collection/src/errors.ts:33](https://github.com/fezproof/tanstack-db/blob/main/packages/query-db-collection/src/errors.ts#L33)
