...
Defined in: [packages/query-db-collection/src/errors.ts:55](https://github.com/fezproof/tanstack-db/blob/main/packages/query-db-collection/src/errors.ts#L55)
...
Defined in: [packages/query-db-collection/src/errors.ts:56](https://github.com/fezproof/tanstack-db/blob/main/packages/query-db-collection/src/errors.ts#L56)
