...
Defined in: [packages/query-db-collection/src/errors.ts:76](https://github.com/fezproof/tanstack-db/blob/main/packages/query-db-collection/src/errors.ts#L76)
...
Defined in: [packages/query-db-collection/src/errors.ts:77](https://github.com/fezproof/tanstack-db/blob/main/packages/query-db-collection/src/errors.ts#L77)
