...
Defined in: [packages/query-db-collection/src/errors.ts:11](https://github.com/fezproof/tanstack-db/blob/main/packages/query-db-collection/src/errors.ts#L11)
...
Defined in: [packages/query-db-collection/src/errors.ts:12](https://github.com/fezproof/tanstack-db/blob/main/packages/query-db-collection/src/errors.ts#L12)
