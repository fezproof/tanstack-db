...
Defined in: [packages/db/src/types.ts:627](https://github.com/fezproof/tanstack-db/blob/main/packages/db/src/types.ts#L627)
...
Defined in: [packages/db/src/types.ts:633](https://github.com/fezproof/tanstack-db/blob/main/packages/db/src/types.ts#L633)
