...
Defined in: [packages/db/src/local-storage.ts:58](https://github.com/fezproof/tanstack-db/blob/main/packages/db/src/local-storage.ts#L58)
...
Defined in: [packages/db/src/local-storage.ts:84](https://github.com/fezproof/tanstack-db/blob/main/packages/db/src/local-storage.ts#L84)
...
Defined in: [packages/db/src/local-storage.ts:72](https://github.com/fezproof/tanstack-db/blob/main/packages/db/src/local-storage.ts#L72)
...
Defined in: [packages/db/src/local-storage.ts:78](https://github.com/fezproof/tanstack-db/blob/main/packages/db/src/local-storage.ts#L78)
...
Defined in: [packages/db/src/local-storage.ts:66](https://github.com/fezproof/tanstack-db/blob/main/packages/db/src/local-storage.ts#L66)
